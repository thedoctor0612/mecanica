...
import { Marque, MarqueService } from '../marque';
...
export class CarDialogComponent implements OnInit {
    ...
    ngOnInit() {
        this.isSaving = false;
        this.marqueService.query()
            .subscribe((res: HttpResponse<Marque[]>) => { this.marques = res.body; }, (res: HttpErrorResponse) => this.onError(res.message));
    ...
    trackMarqueById(index: number, item: Marque) {
        return item.id;
    }
