package org.ms.mecanica.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            cm.createCache(org.ms.mecanica.repository.UserRepository.USERS_BY_LOGIN_CACHE, jcacheConfiguration);
            cm.createCache(org.ms.mecanica.repository.UserRepository.USERS_BY_EMAIL_CACHE, jcacheConfiguration);
